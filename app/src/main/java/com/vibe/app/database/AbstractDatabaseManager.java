 ...
 * @作 用:app数据库抽象操作管理类，实现增、删、查、改等操作
 * @创 建 人: 林国定 邮箱：linggoudingg@gmail.com
 * @日 期: 2016/5/3 0003  23:33
 */
public abstract class AbstractDatabaseManager<M, K> implements IDatabase<M, K> {

    private static final String DEFAULT_DATABASE_NAME = "vibe.db";

    private static BaseOpenHelper mHelper;
     ...
     */
    private static BaseOpenHelper getOpenHelper(@NonNull Context context, @Nullable String dataBaseName) {
        closeDbConnections();
        return new BaseOpenHelper(context, dataBaseName, null);
    }
