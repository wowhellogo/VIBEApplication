...
public abstract class BaseLoadBindingActivity<T> extends BaseActivity<LoadPresenter> implements ILoadPageListDataView<T>, SwipeRefreshLayout.OnRefreshListener, LoadingLayout.OnReloadListener, OnRVItemClickListener {
    protected LoadingLayout mLoadingLayout;
    protected RecyclerView mRecyclerView;
    protected SwipeRefreshLayout mRefreshLayout;
    protected BaseBindingRecyclerViewAdapter mAdapter;
